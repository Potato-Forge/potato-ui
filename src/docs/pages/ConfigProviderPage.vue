...
<template>
  <article class="page">
    <header class="page-header">
      <h1>PfConfigProvider</h1>
      <p>{{ t('configProvider.description') }}</p>
    </header>

    <section class="section">
      <h2>{{ t('section.installation') }}</h2>
      <PfCode>pnpm dlx @potato-forge/cli add pf-config-provider</PfCode>
    </section>
    ...
    <section class="section">
      ...
      <div class="preview">
        <PfConfigProvider>
          <PfText>{{ t('configProvider.wrapped') }}</PfText>
        </PfConfigProvider>
      </div>
    </section>
    ...
    <section class="section">
      ...
      <table class="api-table">
        ...
        <tbody>
          <tr><td>slot</td><td>default</td><td>{{ t('configProvider.api.slot') }}</td></tr>
        </tbody>
      </table>
    </section>
