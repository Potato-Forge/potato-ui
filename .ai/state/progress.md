...
| 模块                   | 状态       | 完成度                                                                                      |
| ---------------------- | ---------- | ------------------------------------------------------------------------------------------- |
| Pf 组件迁移            | ✅ 完成     | 100% (22/22 迁移 + 2 个抽离组件)                                                            |
| UI 基元层              | ✅ 完成     | 100% (16 系列)                                                                              |
...
| Registry 安装器        | ✅ 初版完成 | `pnpm dlx @potato-forge/cli add` 支持递归依赖与文件写入；`pnpm pf:add` 是本仓库本地 wrapper |
...
| PfDataTable 请求边界   | ✅ 完成     | 去除 vue-query，改为 Promise request props                                                  |
| 表单输入组件抽离       | ✅ 完成     | PfDatePicker 独立 registry item                                                             |
